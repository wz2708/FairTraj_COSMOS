...
object_type = {
    MetaDriveType.UNSET: 0, "UNSET": 0,
    MetaDriveType.VEHICLE: 1, "VEHICLE": 1,
    MetaDriveType.PEDESTRIAN: 2, "PEDESTRIAN": 2,
    MetaDriveType.CYCLIST: 3, "CYCLIST": 3,
    MetaDriveType.OTHER: 4, "OTHER": 4,
}
...
traffic_light_state_to_int = {
    ...
    MetaDriveType.LANE_STATE_ARROW_STOP: 1, "LANE_STATE_ARROW_STOP": 1,
    MetaDriveType.LANE_STATE_ARROW_CAUTION: 2, "LANE_STATE_ARROW_CAUTION": 2,
    MetaDriveType.LANE_STATE_ARROW_GO: 3, "LANE_STATE_ARROW_GO": 3,

    # // Standard round traffic signals.
    MetaDriveType.LANE_STATE_STOP: 4, "LANE_STATE_STOP": 4,
    MetaDriveType.LANE_STATE_CAUTION: 5, "LANE_STATE_CAUTION": 5,
    MetaDriveType.LANE_STATE_GO: 6, "LANE_STATE_GO": 6,

    # // Flashing light signals.
    MetaDriveType.LANE_STATE_FLASHING_STOP: 7, "LANE_STATE_FLASHING_STOP": 7,
    MetaDriveType.LANE_STATE_FLASHING_CAUTION: 8, "LANE_STATE_FLASHING_CAUTION": 8,
}
