...
class BaseModel(pl.LightningModule):
    ...
    def compute_metrics_av2(self, pred_dicts):
        ...
        self.log('val/av2_official_brier_minADE', metric_results['brier_min_ADE'], prog_bar=True, on_step=False,
                 on_epoch=True)
        self.log('val/av2_official_brier_minFDE', metric_results['brier_min_FDE'], prog_bar=True, on_step=False,
                 on_epoch=True)
